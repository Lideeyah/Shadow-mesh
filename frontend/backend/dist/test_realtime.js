...
var SOCKET_URL = 'http://localhost:3002';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    socket.on('agent:progress', function (data) {
                        console.log('[Test] Agent Progress:', data);
                    });
                    socket.on('agent:step', function (data) {
                        console.log('[Test] Agent Step:', data);
                    });
                    socket.on('agent:success', function (data) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, axios_1.default.post("".concat(API_URL, "/agent/command"), {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('[Test] Command Failed:', error_1.message);
                    return [3 /*break*/, 5];
